        ...
        <ResponsiveContainer className="max-w-4xl my-8">
          <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold mb-2">GAAPIO SUBSCRIPTION SERVICES AGREEMENT</h1>
            ...
            <ScrollArea className="h-[60vh]">
              <div className="pr-4">
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">2. ACCESS & USE RIGHTS</h2>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">3. CUSTOMER RESPONSIBILITIES</h2>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">4. FEES, BILLING & TAXES</h2>
                  
                  <h3 className="text-lg font-medium mb-2">4.1 Fees and Payment</h3>
                  <p className="mb-3">
                  ...
                  <h3 className="text-lg font-medium mb-2">4.2 Usage-Based Adjustments</h3>
                  <p className="mb-3">
                  ...
                  <h3 className="text-lg font-medium mb-2">4.3 Taxes</h3>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">5. TERM & TERMINATION</h2>
                  
                  <h3 className="text-lg font-medium mb-2">5.1 Term</h3>
                  <p className="mb-3">
                    This Agreement shall remain in effect for the duration of all active Subscription Terms unless 
                    earlier terminated.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">5.2 Termination</h3>
                  ...
                  <h3 className="text-lg font-medium mb-2">5.3 Effect of Termination</h3>
                ...
                <section className="mb-6">
                  ...
                  <h3 className="text-lg font-medium mb-2">6.2 License to Data</h3>
                  <p className="mb-3">
                    Customer grants Gaapio a limited license to use Customer Content for the purpose of providing 
                    the AI Services.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">6.3 Usage Data and Improvements</h3>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">7. CONFIDENTIALITY</h2>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">8. WARRANTIES & DISCLAIMERS</h2>
                  
                  <h3 className="text-lg font-medium mb-2">8.1 Limited Warranty</h3>
                  <p className="mb-3">
                    Gaapio warrants that the AI Services will materially conform to the applicable Documentation 
                    during the Subscription Term.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">8.2 Disclaimers</h3>
                  ...
                  <h3 className="text-lg font-medium mb-2">8.3 Outputs and Reliance</h3>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">11. COMPLIANCE, SECURITY, & DATA PROCESSING</h2>
                  
                  <h3 className="text-lg font-medium mb-2">11.1 Data Security</h3>
                  <p className="mb-3">
                    Gaapio implements industry-standard technical and organizational safeguards to protect Customer Content.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">11.2 Data Processing</h3>
                  <p className="mb-3">
                    If required by applicable law (e.g., GDPR or CCPA), the parties will execute a separate Data 
                    Processing Addendum.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">11.3 Export Compliance</h3>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">12. DISPUTE RESOLUTION & GOVERNING LAW</h2>
                  <p>
                ...
                <section className="mb-6">
                  <h2 className="text-xl font-semibold mb-3 text-primary">13. GENERAL PROVISIONS</h2>
                  
                  <h3 className="text-lg font-medium mb-2">13.1 Entire Agreement</h3>
                  <p className="mb-3">
                    This Agreement constitutes the entire agreement between the parties and supersedes all prior agreements.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">13.2 Assignment</h3>
                  <p className="mb-3">
                    Neither party may assign this Agreement without written consent, except to a successor entity.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">13.3 Force Majeure</h3>
                  <p className="mb-3">
                    Neither party shall be liable for delays due to causes beyond their reasonable control.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">13.4 Counterparts</h3>
                  <p className="mb-3">
                    This Agreement may be executed in counterparts, including electronically.
                  </p>
                  
                  <h3 className="text-lg font-medium mb-2">13.5 No Legal Advice</h3>
                  <p>
