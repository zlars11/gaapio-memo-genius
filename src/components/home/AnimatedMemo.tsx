    ...
    const timer = setTimeout(() => {
      ...
      if (typedElementRef.current) {
        typedInstanceRef.current = new Typed(typedElementRef.current, {
          ...
          typeSpeed: 60, // Increased typing speed
          backSpeed: 0,
          showCursor: true,
          cursorChar: '|',
          loop: false,
  ...
  return (
    <div className="flex items-center justify-center overflow-hidden py-4 mx-4">
      <div 
        ...
        className={`w-full max-w-[900px] p-0 rounded-lg transform rotate-[-2deg] border border-gray-200 shadow-[0_0_15px_rgba(0,0,0,0.1)] transition-opacity duration-500 ${loaded ? 'opacity-100' : 'opacity-0'}`}
        style={{
          minHeight: isSmallScreen ? '380px' : '520px', 
          position: 'relative',
          maxHeight: '80vh'
        }}
      >
        ...
        <div 
          ...
          style={{
            top: isSmallScreen ? '90px' : '150px',
            left: isSmallScreen ? '45px' : '190px',
            ...
            transform: 'rotate(-2deg)', // Matched with container rotation
