...
export function HowItWorksSection() {
  ...
  return (
    <section 
      id="how-it-works" 
      ref={sectionRef}
      className="py-20 md:py-32 relative overflow-hidden dark:bg-background"
      style={{
    ...
    >
      <div className="container px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div 
            className={cn(
              "flex flex-col bg-white dark:bg-[#1a1a1a] rounded-2xl p-8 relative overflow-hidden transition-all",
          ...
          >
            <div className="absolute right-6 top-4 text-[100px] font-bold opacity-10 text-[#339CFF] dark:opacity-15">
              01
            </div>
